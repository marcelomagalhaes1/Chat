...
public class Servidor {
    ...
    // É eficiente para cenários onde leituras (broadcasts) são mais frequentes que
    // escritas (conexões/desconexões).
     ...
     * Este método é sincronizado para evitar condições de corrida ao adicionar
     * clientes
    ...
    public void removeClient(ClientHandler clientHandler) {
        ...
        if (clientHandler == leader) {
            ...
            // System.out.println("Novo líder definido: " + leader.getUsername());
            // broadcastMessage("[SISTEMA] " + leader.getUsername() + " é o novo líder.",
            // null);
            // }
        }
    }
